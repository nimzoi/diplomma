...
class TestEliLoading:
    def test_loads_real_eli_chunks(self, raw_data_dir: Path, has_raw_data: bool) -> None:
        if not has_raw_data:
...
class TestConsumerQuestionsLoading:
    def test_loads_real_consumer_questions(self, raw_data_dir: Path, has_raw_data: bool) -> None:
        if not has_raw_data:
...
class TestSampleJsonlIntegrity:
    ...
    def test_uokik_jsonl_is_valid_json(self, raw_data_dir: Path, has_raw_data: bool) -> None:
        if not has_raw_data:
