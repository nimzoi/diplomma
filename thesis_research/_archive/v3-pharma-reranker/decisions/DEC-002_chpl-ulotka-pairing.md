...
Sources research R2 zwerifikował, że **w literaturze brak publicznie udokumentowanej polskiej pary ChPL↔Ulotka jako training corpus**. Najbliższa istniejąca praca: Grabowski 2018 — *English-Polish comparable PIL corpus* — ale to **cross-language, nie intra-Polish cross-register**.
...
2. **Literature gap potwierdzony.** Sources research R2 nie znalazł publicznie udokumentowanego Polish ChPL↔Ulotka aligned corpus. Najbliższa istniejąca praca: Grabowski (2018) [1] — *English-Polish comparable PIL corpus* — cross-language (EN→PL), **nie** intra-PL cross-register.
